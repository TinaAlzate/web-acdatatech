...
export const MaintenanceDetails = () => {
  ...
  return (
    <section className="section-maintenance details">
      <Helmet>
        <title>Mantenimiento | AC datatech</title>
      </Helmet>
      ...
      <div className="body-services-details container-fluid" id="accordionExample">
        <div className="accordion">
          <Accordion items={itemsMaintenance} />
        </div>
      ...
      <div className="other-services container-fluid">
        ...
        <div className="items-details os-maintenance">
          <Service items={othersMaintenance} />
        </div>
      </div>
    </section>
  )
